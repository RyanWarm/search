...
int main(int argc, char* argv[])
{
    try
    {
        ...
        string index_dir="";
        string server_type="";
        string memcache_addr="";
        string memcache_version="abc";
        string mongodb_addr="";
        ...
        server_options.add_options()
            ...
            ("memcache-addr", po::value<string>(&memcache_addr), "memcache addr")
            ("memcache-version", po::value<string>(&memcache_version), "memcache version")
            ...
            ("reload-interval", po::value<int>(&reload_interval), "reload interval");
        ...
        g_server = new Server(io_service, port,index_dir.c_str(),st,memcache_addr,memcache_version,mongodb_addr,company_list_filename,company_score_filename,reload_interval);
